...
const buttonStyle = tva({
  ...
  variants: {
    ...
    variant: {
      ...
      solid:
        "bg-[#2F7E79] data-[hover=true]:bg-[#2F7E79] data-[active=true]:bg-[#2F7E79] border-[#2F7E79] data-[hover=true]:border-[#2F7E79] data-[active=true]:border-[#2F7E79] data-[focus-visible=true]:web:ring-indicator-info",
    },
